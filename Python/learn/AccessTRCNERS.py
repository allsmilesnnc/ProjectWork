        ...
        if line.endswith('n'): 
            ...
            if re.search(' SE ',line):
                ...
                if re.search('NER1',SouthE) and not re.search('Broadband ',SouthE):
                    ...
                    #print SENER1NOTBB
                if re.search('NER2',SouthE) and not re.search('Broadband ',SouthE):
                    SENER2NOTBB = SouthE
                    SENER2NOTBBcount = SENER2NOTBBcount + 1
                    #print SENER2NOTBB
                ...
                ThirteenState = line
                ThirteenStatecount = ThirteenStatecount + 1
                print ThirteenState
...
#printing out the counts for the vars
...
print 'The count for all Southeast NERS2 that are not BroadBand is',SENER2NOTBBcount
print 'The count for all the Thirteen State NERS is',ThirteenStatecount
#print durations
